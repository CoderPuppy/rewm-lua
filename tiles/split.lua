...
local function split_type(typ, resizer)
	return function()
		local tile = {
			type = typ;
			parents = {};
...
tiles.hsplit = split_type('hsplit', function(tile)
	...
	return function(child)
		return r(child, split_move)
	end
end)

tiles.vsplit = split_type('vsplit', function(tile)
